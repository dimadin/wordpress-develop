...
class Tests_WP_Customize_Manager extends WP_UnitTestCase {
	...
	function test_customize_pane_settings() {
		...
		$this->assertEqualSets( array( 'theme', 'url', 'browser', 'panels', 'sections', 'nonce', 'autofocus', 'documentTitleTmpl', 'previewableDevices', 'customCss', 'changeset', 'timeouts', 'initialServerDate', 'initialServerTimestamp' ), array_keys( $data ) );
